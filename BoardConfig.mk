...
DEVICE_PATH := device/samsung/gt5note10lte
...
# Assert
TARGET_OTA_ASSERT_DEVICE := gt5note10lte

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 11503632 # This is the maximum known partition size, but it can be higher, so we just omit it
